...
class GetCurrentRegions:
    ...
    def __enter__(self):
        ...
        try:
                ...
                db = self.client['kplc_region_demo']
                cll = db['regions_v2']
...
with Timer() as tm:
    with GetCurrentRegions() as regions:
        pprint(regions)
print(f'the operation took {tm():.2f} seconds')
"""
